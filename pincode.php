...
<meta name="keywords" content="bookworms,library,chennai,mobile,static,online" />
...
<div id="content">
<h2>Pincode</h2>
<h3>Enter pincode of your area to check for delivery prior to subscribing</h3>
<p class="searchform">
<form method="POST" action="online.php">
<center>
Pincode : <br><input type="text" alt="username" name=username class="loginbox" /> <br> <br>
<input type="submit" value="Go!" class="searchbutton" />
</center>
</form>
</p>
