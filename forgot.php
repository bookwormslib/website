...
Customer No. : <br><input type="text"  name=password class="loginbox"> <br> <br>
Date of Birth(DD-MM-YYYY) : <br><input type="text"  name=password class="loginbox"> <br> <br>
New Password : <br><input type="password"  name=password class="loginbox"> <br> <br>
