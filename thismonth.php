...
" and customer_check_out.status like '1' and 
extract(year_month from customer_check_out.check_out_date) = extract(year_month from now())";
...
?>
<div id="content">
<center><h3>Your books during this month</h3></center>
</div><br>
<div id="content">
...
<td align='center'><?php echo $line['chk'];?></td>
<td align='center'><?php echo $line['due'];?></td>
<td align='center'>
<a class="nav sub1" href="bdetailonline.php?invno=<?php echo $line['invno'];?>">Details</a>
<a class="nav sub1" href="thismonth.php?function=return&invno=<?php echo $line['invno'];?>">Return</a>
</td>
</tr>
<?php
}
...
?>
<div id="content">
<center><h3>No books borrowed during this month</h3></center>
</div>
<?php
}
?>
