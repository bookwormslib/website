...
<meta name="description" content="bookworms library chennai new additions" />
<meta name="keywords" content="bookworms,library,chennai,mobile,online,new,additions,latest" />
...
?>
<div id="content">
<center><h3>Latest Books in Library</h3></center>
</div><br>
<div id="content">
...
?>
<th align='center'>
<a href="bdetailonline.php?invno=<?php echo $line['inventory_no'];?>">
<?php echo $line['title'];?></a></th>
<td align='center'><?php echo $line['author'];?></td>
<td align='center'><?php echo $line['subject'];?></td>
</tr>
<?php
}
?>
...
?>
<div id="content">
<center><h3>No latest books</h3></center>
</div>
<?php
}
?>
